  ...
  public class JavascriptWorker : Worker
  {
      ...
      : base(api, filename)
    {
      ...
      _engine.SetValue("OverrideScriptTimeout", new Action<int>(OverrideScriptTimeout))
             ...
             .SetValue("GetTmAccum", new Func<int, int, int, float>(GetTmAccum))
             .SetValue("GetTmAccumOrDefault", new Func<int, int, int, float, float>(GetTmAccumOrDefault))
             .SetValue("GetTmAccumLoad", new Func<int, int, int, float>(GetTmAccumLoad))
             .SetValue("GetTmAccumLoadOrDefault", new Func<int, int, int, float, float>(GetTmAccumLoadOrDefault))
             .SetValue("GetTmAccumName", new Func<int, int, int, string>(GetTmAccumName))
             .SetValue("GetTmAccumUnit", new Func<int, int, int, string>(GetTmAccumUnit))
             .SetValue("IsTmAccumFlagRaised", new Func<int, int, int, TmFlags, bool>(IsTmAccumFlagRaised))
             .SetValue("GetTmAccumFromRetro", new Func<int, int, int, long, float?>(GetTmAccumFromRetro))
